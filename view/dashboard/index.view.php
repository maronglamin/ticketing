...
<div class="table-responsive">
    <table class="table table-bordless text-white" style="table-layout: fixed;">
        <thead class="table-secondary">
            <tr>
                <th style="width: 18%; white-space: nowrap;">Request_id</th>
                <th style="width: 52%; word-wrap: break-word;">Ticket Summary</th>
        ...
        <?php foreach($data as $value):?>
            <tr class="text-dark">
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="ms-3">
                            <p class="fw-bold mb-1">Created At: <?= regularDate($value['make_at']) ?></p>
                            <p class="text-muted mb-0">
                                <strong>Updated at: <?= (($value['updated_at'] === NULL)? '' : core\DateTimeDiff::TimeDifference($value['make_at'], $value['updated_at'])) ?></strong>
                            </p>
                        </div>
                    </div>
                </td>
