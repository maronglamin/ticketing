        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="details-header mt-5 pt-2 d-flex align-items-center justify-content-center">
                    <img src="{{ root() }}/public/img/saved.png" alt="Company Logo" class="logo">
                </div>
                @foreach($transactions as $transaction)
                <div class="details-container">
                    @if(userACL() === core\Response::AUTH && $transaction['Approved_by'] === NULL && $transaction['transaction_status'] !== 'REJECTED')
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#reviewModal">Approve</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea type="text" style="height: 90px;" class="form-control @if(isset($errors['comment']))is-invalid @endif" name="comment" id="comment" placeholder="Make a comment"></textarea>
                                            </div>
                                            </div>
                    ...
                    @elseif (userACL() === core\Response::REV && $transaction['review_by'] === NULL && $transaction['Approved_by'] !== NULL && $transaction['transaction_status'] !== 'REJECTED')
                        <div class="d-flex align-items-center justify-content-between mb-2">
