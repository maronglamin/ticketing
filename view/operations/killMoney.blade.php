                ...
                <div class="summary-card">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php foreach ($transactions as $transaction)
                            <li class="list-group-item"><?= $transaction['trxDate'] ?> - GMD <?= format_number($transaction['transaction_amount']) ?> </li>
                        <?php endforeach;?>
                    </ul>
                </div>
            </div>
                        ...
                        <form action="<?= route('kill/money/new') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <?php endforeach;?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?php if (isset($errors['Transaction_amount']))is-invalid <?php endif;?>" min="0" name="Transaction_amount" id="Transaction_amount" placeholder="Enter amount">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?php if (isset($errors['kill_money_trxnid']))is-invalid <?php endif;?>" id="kill_money_trxnid" name="kill_money_trxnid">
