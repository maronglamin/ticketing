...
<?php foreach($ticket_detail as $detail):?>
    <p class="fw-bold fs-4">REF/Agent/LOGS - APS IMS Ticketing::<?= $detail['ticketId']?></p>
    <div class="card mt-5">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <form action="<?= route('status/change/agent/logs')?>" method="post">
            ...
            <div class="mt-3">
                <form action="<?= route('ticket/comments/agentLog')?>" method="post" enctype="multipart/form-data">
