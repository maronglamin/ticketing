                ...
                <div class="explorer-container">
                        ...
                        <ul class="list-group">
                            ...
                            <?php if  ( isBankPlay() ):?>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="ms-2"><?p= $file['transaction_filename'] ?></span>
                                </div>
                                <div class="action-icons">
                                <strong><span class="<?php ($file['transaction_status'] === core\Response::PENDING)? 'text-danger' : 'text-primary' ?> p-2"><?= $file['transaction_status'] ?></span></strong>
                                    <a href="<?php route('instrustions/view/print') ?>?print=<?= $file['folder_id'] ?>" class="text-danger"><i class="bi bi-printer"></i> Print File</a>
                                    <a href="<?php route('instrustions/view/details') ?>?view=<?= $file['folder_id'] ?>" class="text-success"><i class="bi bi-eye"></i> View</a>
                                </div>
                            ...
                            <li class="list-group-item d-flex align-items-center justify-content-between">
                                ...
                                <strong><span class="<?= ($file['transaction_status'] === core\Response::PENDING)? 'text-danger' : 'text-primary' ?> p-2"><?= $file['transaction_status'] ?></span></strong>
                                    <?php if  ($file['transaction_status'] === 'PENDING'):?>
                                        ...
                                        <?php endif;?>
                                    <?php endif;?>
                                    <?php if  ($file['transaction_status'] !== core\Response::APPROVE || $file['transaction_status'] !== core\Response::STATUS_CLOSED):?>
                                        <?php if ($file['debit_note_form_id'] !== null):?>
                                            <?php if  (!( userACL() === core\Response::REV ||  userACL() === core\Response::AUTH)):?>
                                                <?php if (($file['transaction_status'] === "NOTE_CREATED"  || $file['transaction_status'] === 'PENDING')) :?>
                    ...
                    <nav aria-label="Page navigation example p-2">
                        <ul class="pagination justify-content-end">
                            ...
                            <!-- Next Button -->
                            <li class="page-item <?php ($page >= $pages) ? 'disabled' : ''  ?>">
