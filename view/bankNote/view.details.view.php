        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="details-row d-flex align-items-center">
                    ...
                    <?php if ($transaction['approved_by'] === NULL && userACL() === core\Response::AUTH && $transaction['debit_note_form_id'] !== NULL):?>
                        <div class="d-flex align-items-center justify-content-end mb-2">
                            <div>
                                <form action="<?= route('instruction/approve') ?>" method="post" class="nav-link" role="button">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#reviewModal">Approved</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <div class="mb-3">
                                                <label for="comment" class="form-label"><strong>Approve Comment</strong></label>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div><h3>Approve/Reject Transaction</h3></div>
                            <div>
                    ...
                    <?php elseif  (userACL() === core\Response::REV && $transaction['reviewed_by'] === NULL && $transaction['approved_by'] !== NULL && $transaction['transaction_status'] !== 'REJECTED' && $transaction['debit_note_form_id'] !== NULL):?>
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <div><h3>Review Transaction</h3></div>
                            <div>
                    ...
                    <?php elseif  ((isOtherBankUser() || isBankPlay()) && $transaction['transaction_status'] !== Core\Response::STATUS_CLOSED && $transaction['transaction_status'] === 'Signed & Approved'):?>
                        <div class="d-flex align-items-center justify-content-between mb-2">
