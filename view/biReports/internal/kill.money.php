...
<?php if ($_SERVER['REQUEST_URI'] !== root(). '/kill/search'):?>
<div class="flex flex-col md:flex-row bg-white rounded-lg p-6 border border-gray-300 shadow-md">
    ...
    <div class="flex items-center justify-between mb-4">
            ...
            <h3 id="reportTitle" class="text-lg font-semibold text-black">Kill Money Report</h3>

            <!-- Right Side: Inputs & Button -->
            <form action="<?= route('kill/search')?>" method="post" class="flex items-center space-x-4">
                <!-- Start Time -->
        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-max border border-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="border px-4 py-2">Form id</th>
                        <th class="border px-4 py-2">Withdraw To Trust Id</th>
                        <th class="border px-4 py-2">Agent Name</th>
                        <th class="border px-4 py-2">Agent Back Acc#</th>
                        <th class="border px-4 py-2">Transaction Amount</th>
                        <th class="border px-4 py-2">Date</th>
                        <th class="border px-4 py-2">Status</th>
                        <th class="border px-4 py-2">Approved by</th>
                ...
                <?php foreach($results as $value):?>
                    <tr>
                        ...
                        <td class="px-4 py-2 text-start"><?= $value['kill_money_trxnid']?></td>
                        <td class="px-4 py-2 text-start"><?= $value['agent_name']?></td>
                        <td class="px-4 py-2 text-start"><?= $value['agent_acc_number']?></td>
