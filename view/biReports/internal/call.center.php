...
<?php if ($_SERVER['REQUEST_URI'] !== root(). '/callcenter/reps/search'):?>
<div class="flex flex-col md:flex-row bg-white rounded-lg p-6 border border-gray-300 shadow-md m-6">
    ...
    <div class="flex items-center justify-between mb-4">
            ...
            <h3 id="reportTitle" class="text-lg font-semibold text-black">CCR Reports</h3>

            <!-- Right Side: Inputs & Button -->
            <form action="<?= route('callcenter/reps/search')?>" method="post" class="flex items-center space-x-4">
                <!-- Start Time -->
            ...
            <table class="w-full min-w-max border border-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border px-4 py-2">Call Reason</th>
                        <th class="border px-4 py-2">Customer Phone#</th>
                        <th class="border px-4 py-2">CCR</th>
            ...
            <table class="w-full min-w-max border border-gray-200">
                ...
                <?php foreach($results as $value):?>
                    <tr>
                        ...
                        <td class="px-4 py-2 text-start"><?= $value['transactionType']?></td>
                        <td class="px-4 py-2 text-start"><?= $value['reasonForCall']?></td>
                        <td class="px-4 py-2 text-end"><?= $value['customerName']?></td>
                        <td class="px-4 py-2 text-end"><?= $value['phoneNumber']?></td>
