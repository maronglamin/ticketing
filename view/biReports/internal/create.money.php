...
<?php if ($_SERVER['REQUEST_URI'] !== root(). '/create/search'):?>
<div class="flex flex-col md:flex-row bg-white rounded-lg p-6 border border-gray-300 shadow-md m-6">
    ...
    <div class="flex items-center justify-between mb-4">
            ...
            <form action="<?= route('create/search')?>" method="post" class="flex items-center space-x-4">
                <!-- Start Time -->
            ...
            <table class="w-full min-w-max border border-gray-200">
                ...
                <?php foreach($results as $value):?>
                    <tr>
                        ...
                        <td class="px-4 py-2 text-start"><?= $value['bank_name']?></td>
                        <td class="px-4 py-2 text-start"><?= $value['bank_trxn_ref']?></td>
