...
<?php if ($_SERVER['REQUEST_URI'] !== root(). '/comulation/search'):?>
<div class="flex flex-col md:flex-row bg-white rounded-lg p-6 border border-gray-300 shadow-md">
    ...
    <div class="flex items-center justify-between mb-4">
            ...
            <h3 id="reportTitle" class="text-lg font-semibold text-black">Comulative Settlement Report</h3>

            <!-- Right Side: Inputs & Button -->
            <form action="<?= route('comulation/search')?>" method="post" class="flex items-center space-x-4">
                <!-- Start Time -->
            ...
            <table class="w-full min-w-max border border-gray-200">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border px-4 py-2">Agent Wallet#</th>
                        <th class="border px-4 py-2">Settlement Count</th>
                        <th class="border px-4 py-2">Total Transaction Amount</th>
                        <th class="border px-4 py-2">Average Transaction Amount</th>
                    </tr>
                </thead>
                <tbody>
